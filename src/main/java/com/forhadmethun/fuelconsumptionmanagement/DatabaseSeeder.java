...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        registrationEntities.add(new RegistrationEntity(1L,"D", 10.10, 12.5, "12345",01,02,2019));
        registrationEntities.add(new RegistrationEntity(2L,"D", 10.10, 12.5, "12345",01,03,2016));
        ...
        registrationEntities.add(new RegistrationEntity(0L,"D", 10.10, 12.5, "12345",07,1,2018));
        registrationEntities.add(new RegistrationEntity(0L,"D", 10.10, 12.5, "12345",07,15,2018));
